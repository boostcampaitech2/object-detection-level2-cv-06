...
train_json = read_json('/opt/ml/detection/dataset/team_train.json')
sudo_json = read_json('/opt/ml/detection/dataset/candidate/pesudo_0.3_.json')
...
save_anno(train_json, '/opt/ml/detection/dataset/candidate/trainwithpesudo_0.3.json')
